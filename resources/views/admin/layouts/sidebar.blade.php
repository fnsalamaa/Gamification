...
<aside id="logo-sidebar"
   ...
   <div class="h-full px-3 py-4 overflow-y-auto">
      <a href="https://flowbite.com/" class="flex items-center ps-2.5 mb-6">
         <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 me-3 sm:h-10" alt="Logo" />
         <span class="text-white text-xl font-bold whitespace-nowrap">Flowbite</span>
      </a>
